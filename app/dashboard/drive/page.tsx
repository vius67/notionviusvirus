...
function FileIcon({ mime, name, size = 28 }: { mime?: string; name?: string; size?: number }) {
  ...
  if (m.startsWith('audio/')) return <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>
